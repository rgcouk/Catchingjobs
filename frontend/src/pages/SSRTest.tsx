...
export default function SSRTest() {
  ...
  return (
    ...
    >
      ...
      <div className="max-w-xl w-full bg-[var(--color-paper-2)] border border-[var(--color-rule)] rounded-md p-8 shadow-sm space-y-6">
        ...
        <div className="grid grid-cols-2 gap-4 text-left pt-4 border-t border-[var(--color-rule)]">
          <div className="bg-[var(--color-paper)] p-3 rounded-md border border-[var(--color-rule)]">
