...
export default function CatcherPortal({ applications, onUpdateProfile }: CatcherPortalProps) {
  ...
  return (
    <div className="space-y-8 font-sans">
      {!currentUser ? (
        // Login View
        <div className="max-w-md mx-auto bg-card border border-border rounded-md p-6 sm:p-8 space-y-6 shadow-sm">
          <div className="text-center space-y-2">
            <div className="w-12 h-12 bg-primary text-white rounded-md flex items-center justify-center mx-auto shadow-sm">
          ...
          <form onSubmit={handleLoginSubmit} className="space-y-4">
            <div className="space-y-1.5">
              ...
              <Input
                ...
                className="w-full px-3.5 py-2 rounded-md border border-border text-xs focus:outline-none focus:ring-1 focus:ring-ring bg-muted/50 font-mono"
              />
            </div>

            {loginError && (
              <div className="p-3 bg-red-50 border border-red-200 rounded-md text-red-800 text-[11px] flex items-start gap-2">
            ...
            <Button
              type="submit"
              className="w-full bg-primary hover:bg-primary/90 text-white font-semibold py-2.5 px-4 rounded-md text-xs tracking-wide transition-all shadow-md flex items-center justify-center gap-2 cursor-pointer"
            >
          ...
          <div className="grid grid-cols-2 gap-3">
            <Button
              ...
              className="bg-card hover:bg-muted/50 text-muted-foreground border border-border py-2 px-3 rounded-md text-xs font-semibold flex items-center justify-center gap-2 transition-all cursor-pointer"
            >
          ...
          <div className="p-4 bg-muted/50 rounded-md border border-border text-left space-y-2">
        ...
        <div className="space-y-6">
          <div className="bg-card border border-border rounded-md p-5 sm:p-6 shadow-sm flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              <div className="w-12 h-12 bg-primary text-white rounded-md flex items-center justify-center font-bold text-base shadow-sm shrink-0">
                {currentUser.name
                  .split(' ')
                  .map((n) => n[0])
                  .join('')}
            ...
            <Button
              ...
              className="text-xs text-muted-foreground hover:text-foreground bg-muted/50 hover:bg-muted border border-border font-semibold py-1.5 px-3 rounded-md flex items-center gap-1.5 cursor-pointer self-stretch md:self-auto justify-center"
            >
            ...
            {activeTab === 'profile' &&
              (currentUser.profileFormCompleted && !isEditingProfile ? (
                ...
                <div className="max-w-2xl space-y-6">
                  <div className="bg-emerald-50 border-2 border-emerald-500/30 rounded-md p-5 sm:p-6 flex items-start gap-4 shadow-sm">
                  ...
                  <div className="bg-card border border-border rounded-md p-5 sm:p-6 shadow-sm space-y-6">
                  ...
                  <div className="bg-card border border-border rounded-md p-5 sm:p-6 shadow-sm space-y-5">
                ...
                <form
                  ...
                  className="max-w-2xl bg-card border-2 border-foreground/10 rounded-md shadow-md overflow-hidden text-left"
                >
                  {/* Form Header Banner */}
                    ...
                    <div className="grid sm:grid-cols-2 gap-4">
                      <div className="space-y-1">
                        ...
                        <Input
                          ...
                          className="w-full border border-border bg-muted/50 rounded-md px-3 py-2 text-xs focus:outline-none focus:ring-1 focus:ring-ring"
                        />
                        {formErrors.dob && (
                      ...
                      <div className="space-y-1">
                        ...
                        <Input
                          ...
                          className="w-full border border-border bg-muted/50 rounded-md px-3 py-2 text-xs focus:outline-none focus:ring-1 focus:ring-ring font-mono tracking-wider"
                        />
                      ...
                      <div className="space-y-1">
                        ...
                        <Input
                          ...
                          className="w-full border border-border bg-muted/50 rounded-md px-3 py-2 text-xs focus:outline-none focus:ring-1 focus:ring-ring font-mono"
                        />
                        {formErrors.postcode && (
                          <p className="text-[10px] text-red-600 font-semibold">
                            {formErrors.postcode}
                      ...
                      <div className="space-y-1">
                        ...
                        <Input
                          ...
                          className="w-full border border-border bg-muted rounded-md px-3 py-2 text-xs text-muted-foreground focus:outline-none"
                        />
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="grid sm:grid-cols-2 gap-4">
                      ...
                      <div className="space-y-1">
                        ...
                        <Input
                          ...
                          className="w-full border border-border bg-muted/50 rounded-md px-3 py-2 text-xs focus:outline-none focus:ring-1 focus:ring-ring font-mono tracking-widest"
                        />
                  ...
                  <div className="p-5 sm:p-6 space-y-4 border-b border-border">
                    ...
                    <div className="space-y-4">
                      {/* Question A */}
                      <div className="space-y-1.5 p-3.5 bg-muted/50 rounded-md border border-border/80">
                        ...
                        <div className="flex gap-2 pt-1.5">
                          <Button
                            ...
                            className={`px-4 py-1.5 rounded-md text-xs font-semibold border transition-all cursor-pointer ${hasAsthmaOrAllergies === true ? 'bg-red-100 border-red-500 text-red-800' : 'bg-card border-border text-muted-foreground hover:bg-muted/50'}`}
                          >
                            Yes, I do
                          </Button>
                          <Button
                            ...
                            className={`px-4 py-1.5 rounded-md text-xs font-semibold border transition-all cursor-pointer ${hasAsthmaOrAllergies === false ? 'bg-emerald-100 border-emerald-500 text-emerald-800' : 'bg-card border-border text-muted-foreground hover:bg-muted/50'}`}
                          >
                            No, I do not
                          </Button>
                        </div>
                      ...
                      <div className="space-y-1.5 p-3.5 bg-muted/50 rounded-md border border-border/80">
                        ...
                        <div className="flex gap-2 pt-1.5">
                          <Button
                            ...
                            className={`px-4 py-1.5 rounded-md text-xs font-semibold border transition-all cursor-pointer ${hasBackIssues === true ? 'bg-red-100 border-red-500 text-red-800' : 'bg-card border-border text-muted-foreground hover:bg-muted/50'}`}
                          >
                            Yes, I do
                          </Button>
                          <Button
                            ...
                            className={`px-4 py-1.5 rounded-md text-xs font-semibold border transition-all cursor-pointer ${hasBackIssues === false ? 'bg-emerald-100 border-emerald-500 text-emerald-800' : 'bg-card border-border text-muted-foreground hover:bg-muted/50'}`}
                          >
                            No, I do not
                          </Button>
                        </div>
                      ...
                      <div className="space-y-1.5 p-3.5 bg-muted/50 rounded-md border border-border/80">
                        ...
                        <div className="flex gap-2 pt-1.5">
                          <Button
                            ...
                            className={`px-4 py-1.5 rounded-md text-xs font-semibold border transition-all cursor-pointer ${isFitToLift === true ? 'bg-emerald-100 border-emerald-500 text-emerald-800' : 'bg-card border-border text-muted-foreground hover:bg-muted/50'}`}
                          >
                            Yes, I am fit
                          </Button>
                          <Button
                            ...
                            className={`px-4 py-1.5 rounded-md text-xs font-semibold border transition-all cursor-pointer ${isFitToLift === false ? 'bg-red-100 border-red-500 text-red-800' : 'bg-card border-border text-muted-foreground hover:bg-muted/50'}`}
                          >
                  ...
                  <div className="p-5 sm:p-6 space-y-4 bg-muted/50/50">
                    ...
                    <div className="bg-card border border-border rounded-md p-4 text-[10.5px] text-muted-foreground leading-relaxed font-normal max-h-36 overflow-y-auto space-y-2">
                      <p>
                    ...
                    <div className="flex gap-3 pt-3">
                      <Button
                        type="submit"
                        className="flex-grow bg-primary hover:bg-primary/90 text-white text-xs font-bold py-3 px-4 rounded-md shadow-md transition-all flex items-center justify-center gap-2 cursor-pointer"
                      >
                      ...
                      {currentUser.profileFormCompleted && (
                        <Button
                          ...
                          className="bg-card hover:bg-muted/50 text-muted-foreground border border-border text-xs font-bold py-3 px-4 rounded-md transition-all cursor-pointer"
                        >
                          Cancel
                        </Button>
                      )}
              ...
              <div className="max-w-2xl space-y-4">
                ...
                <div className="grid gap-3">
                  {[
                    ...
                    <div
                      key={idx}
                      className="bg-card border border-border p-4 rounded-md flex items-center justify-between shadow-sm hover:border-border transition-colors group"
                    >
                      <div className="flex items-start gap-3">
                        <div className="p-2 bg-muted/50 text-muted-foreground rounded-md border border-border/50">
            ...
            {activeTab === 'contact' && (
              <div className="max-w-4xl grid md:grid-cols-2 gap-8">
                <div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start gap-3">
                      <div className="p-2 bg-muted/50 border border-border rounded-md text-muted-foreground">
                  ...
                  {contactSent ? (
                    ...
                    <form onSubmit={handleContactSubmit} className="space-y-4">
                      <div className="space-y-1">
                        ...
                        <select className="w-full border border-border bg-muted/50 rounded-md px-3 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-ring">
                      ...
                      <div className="space-y-1">
                        ...
                        <Textarea
                          ...
                          className="w-full border border-border bg-muted/50 rounded-md px-3 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-ring resize-none"
                        ></Textarea>
                      </div>

                      <Button
                        type="submit"
                        className="w-full bg-primary hover:bg-primary/90 text-white font-bold py-2.5 px-4 rounded-md text-xs cursor-pointer transition-colors flex items-center justify-center gap-2"
                      >
