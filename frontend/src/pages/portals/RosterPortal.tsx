...
export default function RosterPortal({ onNavigate }: any) {
  ...
  <span className="tracking-tight text-black">atchingJobs<span className="font-mono">.</span></span>
      ...
      <nav className="hidden md:flex items-center space-x-7 text-sm font-semibold text-black/90 font-display">
        ...
        <a href="sector-chicken.html" className="hover:text-black transition-colors">Chicken Catching</a>
        <a href="sector-turkey.html" className="hover:text-black transition-colors">Turkey Catching</a>
        <Link to="/chickens" className="hover:text-black transition-colors">Locations</Link>
        <Link to="/corporate" className="hover:text-black transition-colors">Growers & Processors</Link>
        <a href="tel:01205330190" className="hover:text-black font-mono">01205 330 190</a>
      </nav>
      <div className="flex items-center space-x-3">
        <a href="portal.html" className="hidden sm:inline-flex items-center px-4 py-2 rounded-md text-xs font-bold text-black border border-black/20 hover:bg-black/5 transition-all">
          Worker Portal
        </a>
        <Link to="/register" className="inline-flex items-center justify-center px-5 py-2.5 rounded-md bg-black text-white hover:bg-neutral-900 text-xs font-bold font-display shadow-sm transition-all transform active:scale-95">
          Quick Apply
        </Link>
      </div>
    </div>
  ...
  <main className="flex-1">
    ...
    <section className="bg-[#FFCC00] pt-10 pb-12 border-b border-black/10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row md:items-center justify-between gap-6">
        ...
        <div className="flex items-center gap-3">
          <div className="p-3 rounded-md bg-white/90 border border-black/10 text-xs font-mono">
    ...
    <section className="py-12 bg-slate-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="p-6 rounded-md bg-white border border-slate-200 shadow-sm space-y-2">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2 p-8 rounded-md bg-white border border-slate-200 shadow-sm space-y-6">
          ...
          <div className="p-8 rounded-md bg-[#FFFDF0] border border-amber-200 shadow-sm space-y-6">
            ...
            <div className="p-4 rounded-md bg-white border border-amber-200 font-mono text-xs font-bold text-black text-center">
              Hotline: 01205 330 190
            </div>
            <a href="tel:01205330190" className="block w-full py-3 text-center rounded-md bg-black text-white font-display font-bold text-xs hover:bg-neutral-800">
  ...
  <span className="tracking-tight text-white">atchingJobs<span className="text-[#FFCC00] font-mono">.</span></span>
          ...
          <p className="text-xs text-neutral-400 leading-relaxed font-sans">
            CatchingJobs is operated by Pullum Ltd under GLAA Licence PULL0001. UK's primary agricultural poultry harvesting contractor supplying verified catching crews across Lincolnshire, Norfolk, Yorkshire, Shropshire, and Suffolk with free heated minibus collection and guaranteed Friday payroll.
          </p>
          <div className="flex flex-wrap items-center gap-x-6 gap-y-2 text-xs font-semibold text-neutral-300 pt-2 font-display">
            ...
            <a href="sector-chicken.html" className="hover:text-[#FFCC00]">Broiler Catching</a>
            <a href="sector-turkey.html" className="hover:text-[#FFCC00]">Turkey Catching</a>
            <a href="region-boston.html" className="hover:text-[#FFCC00]">Boston Depot</a>
            <Link to="/corporate" className="hover:text-[#FFCC00]">Corporate SLA</Link>
            <a href="portal.html" className="hover:text-[#FFCC00]">Worker Portal</a>
          </div>
        </div>
        <div className="space-y-4 md:text-right">
          <div className="inline-flex flex-col md:items-end gap-1.5 p-4 rounded-md bg-neutral-900 border border-neutral-800">
            <span className="text-[11px] font-mono text-[#FFCC00] font-bold uppercase tracking-wider">GLAA Statutory Compliance</span>
            <span className="text-xs text-neutral-300">Licence Ref: <strong className="text-white font-mono">PULL0001</strong> (Active Standard)</span>
            <span className="text-xs text-neutral-400">Defra / Lantra Level 2 Animal Welfare Certified</span>
          </div>
          <p className="text-xs text-neutral-400">
            Payroll Dispatch: Direct BACS Every Friday 08:00 Guaranteed
          </p>
        </div>
      </div>
      <div className="flex flex-col sm:flex-row items-center justify-between text-[11px] text-neutral-400 gap-4">
        <p>&copy; 2026 Pullum Ltd t/a CatchingJobs. All rights reserved. Company Reg 11988241.</p>
        <div className="flex items-center space-x-6">
          <a href="tel:01205330190" className="hover:text-white font-mono">24/7 Operations: 01205 330 190</a>
          <span className="text-neutral-700">&bull;</span>
          <span className="text-neutral-400">Boston Hub, PE21 7TW</span>
        </div>
      </div>
    </div>
  </footer>
