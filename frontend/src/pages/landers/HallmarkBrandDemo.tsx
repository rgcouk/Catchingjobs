 ...
 * theme: custom (Clean Minimal Modern SaaS — grounded in Dribbble Design References)
 * paper: oklch(98.5% 0.005 240) [#F8FAFC] · surface: #FFFFFF · ink: oklch(20% 0.02 260) [#0F172A] · ink-muted: #64748B
 * rule: oklch(92% 0.005 260) [#E2E8F0]
 * accent: Emerald Green oklch(62% 0.17 150) [#059669] / Harvest Amber oklch(65% 0.18 45) [#EA580C] (disciplined ≤ 6% footprint)
 * display: Plus Jakarta Sans (700 bold, tracking -0.03em) · body: Inter · mono: JetBrains Mono (tabular-nums)
 * design-sources: Dribbble Collections (23963312, 19351493, 16062197, 27504183)
 */
...
export default function HallmarkBrandDemo() {
  ...
  return (
    <div className="font-sans w-full bg-[#F8FAFC] text-[#0F172A] selection:bg-[#059669] selection:text-white min-h-screen antialiased">
      <Helmet>
        <title>CatchingJobs | Modern Agricultural Catching & Squad Recruitment</title>
        <meta
          name="description"
          content="Clean, minimal job discovery and workforce management for UK poultry catching crews. Managed by Pullum Ltd."
        />
      </Helmet>
      ...
      {/* Main Nav: Minimal SaaS Three-Section (N1b) */}
      <header className="sticky top-0 z-40 bg-white/90 backdrop-blur-md border-b border-[#E2E8F0]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <Link to="/demo" className="flex items-center gap-2">
              <div className="w-8 h-8 rounded-md bg-[#0F172A] text-white flex items-center justify-center font-bold text-sm">
                CJ
              </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <Link
              to="/chickens"
              className="inline-flex items-center gap-1.5 bg-[#059669] hover:bg-[#047857] text-white text-xs font-mono font-semibold uppercase tracking-wider px-4 py-2.5 rounded-md transition-colors shadow-sm"
            >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              <div className="p-2.5 sm:p-3 bg-[#F8FAFC] rounded-md border border-[#E2E8F0] shadow-sm space-y-3">
                <form
                  onSubmit={handleSearch}
                  className="grid grid-cols-1 sm:grid-cols-12 gap-2 text-xs"
                >
                  <div className="sm:col-span-4 bg-white border border-[#E2E8F0] rounded-md p-2.5 flex flex-col justify-center focus-within:border-[#059669] transition-colors">
                  ...
                  <div className="sm:col-span-4 flex items-stretch">
                    <button
                      type="submit"
                      className="w-full bg-[#059669] hover:bg-[#047857] text-white font-mono uppercase font-semibold text-xs py-3 px-4 rounded-md flex items-center justify-center gap-2 transition-colors cursor-pointer shadow-sm"
                    >
            ...
            {/* Right 5 Columns: Live Shift Stack (Ref 01 & 04 Architecture) */}
                ...
                {filteredShifts.map((shift) => {
                  ...
                  return (
                    <div
                      ...
                      className={`p-4 rounded-md border bg-white transition-all cursor-pointer ${
                        isToggled
      ...
      <section className="py-16 bg-[#F8FAFC] border-b border-[#E2E8F0]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="p-8 sm:p-10 rounded-md bg-white border border-[#E2E8F0] shadow-sm grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            <div className="lg:col-span-7 space-y-6">
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  className="w-full h-2 bg-[#E2E8F0] rounded-md appearance-none cursor-pointer accent-[#059669]"
                />
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  className="w-full h-2 bg-[#E2E8F0] rounded-md appearance-none cursor-pointer accent-[#0F172A]"
                />
                <div className="flex justify-between text-[10px] font-mono text-[#94A3B8]">
            ...
            <div className="lg:col-span-5 p-6 sm:p-8 rounded-md bg-[#F8FAFC] border border-[#E2E8F0] space-y-6 text-center lg:text-left">
              <div>
              ...
              <div className="space-y-2 text-xs font-mono text-[#64748B] bg-white p-4 rounded-md border border-[#E2E8F0]">
              ...
              <Link
                to="/chickens"
                className="w-full inline-flex items-center justify-center gap-2 bg-[#059669] hover:bg-[#047857] text-white font-mono text-xs font-semibold uppercase tracking-wider py-3.5 rounded-md transition-colors shadow-sm cursor-pointer"
              >
      ...
      <section className="py-16 lg:py-24 border-b border-[#E2E8F0] bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
            ...
            <div className="md:col-span-8 p-8 rounded-md bg-[#F8FAFC] border border-[#E2E8F0] flex flex-col justify-between space-y-6">
              <div className="space-y-3">
                <div className="w-10 h-10 rounded-md bg-white border border-[#E2E8F0] flex items-center justify-center text-[#059669]">
            ...
            <div className="md:col-span-4 p-8 rounded-md bg-[#F8FAFC] border border-[#E2E8F0] flex flex-col justify-between space-y-6">
              <div className="space-y-3">
                <div className="w-10 h-10 rounded-md bg-white border border-[#E2E8F0] flex items-center justify-center text-[#EA580C]">
              ...
              <div className="bg-white p-4 rounded-md border border-[#E2E8F0] font-mono space-y-2 text-xs">
                <div className="flex justify-between">
            ...
            <div className="md:col-span-4 p-8 rounded-md bg-[#F8FAFC] border border-[#E2E8F0] flex flex-col justify-between space-y-6">
              ...
              <div className="flex items-center gap-2 bg-[#ECFDF5] p-3 rounded-md border border-[#A7F3D0] text-xs font-mono text-[#065F46] font-semibold">
            ...
            <div className="md:col-span-4 p-8 rounded-md bg-[#F8FAFC] border border-[#E2E8F0] flex flex-col justify-between space-y-6">
              <div className="space-y-3">
                <div className="w-10 h-10 rounded-md bg-white border border-[#E2E8F0] flex items-center justify-center text-[#0F172A]">
              ...
              <Link
                to="/chickens"
                className="inline-flex items-center justify-between bg-white border border-[#E2E8F0] hover:border-[#0F172A] p-3.5 rounded-md text-xs font-mono font-semibold text-[#0F172A] transition-colors"
              >
      ...
      {/* Regional Directory Hub: Clean White Hairline Cards */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {REGIONS.map((region) => (
              <div
                key={region.id}
                className="p-6 rounded-md bg-white border border-[#E2E8F0] hover:border-[#0F172A] transition-colors space-y-4 shadow-sm"
              >
      ...
      <section className="py-16 bg-white border-b border-[#E2E8F0]">
        <div className="max-w-4xl mx-auto px-4 text-center space-y-6">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-2">
            <Link
              to="/chickens"
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-[#059669] hover:bg-[#047857] text-white font-mono text-xs font-semibold uppercase tracking-wider px-8 py-3.5 rounded-md transition-colors shadow-sm cursor-pointer"
            >
            ...
            <Link
              to="/turkeys"
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-white hover:bg-[#F8FAFC] border border-[#E2E8F0] text-[#0F172A] font-mono text-xs font-semibold uppercase tracking-wider px-8 py-3.5 rounded-md transition-colors cursor-pointer"
            >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            ...
            <div className="space-y-2">
              ...
              <ul className="space-y-1 text-[11px]">
                ...
                <li>
                  <Link to="/employee" className="hover:text-[#0F172A]">
