...
export default function RegionLander({ onNavigate }: any) {
  ...
  <header className="bg-[#FFC72C] border-b border-black/10 relative z-30">
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
      ...
      <nav className="hidden md:flex items-center space-x-7 text-sm font-semibold text-black/90 font-display">
        ...
        <Link to="/chickens" className="text-black border-b-2 border-black pb-0.5 font-bold">Locations</Link>
  ...
  {/*  2. HERO SECTION  */}
  <section data-od-id="regional-hero" className="relative bg-[#FFC72C] text-black py-16 lg:py-20 border-b border-black/10 overflow-hidden">
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6 relative z-10">
      <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-black/10 border border-black/15 text-black text-xs font-mono font-bold">
        ...
        <span>5 HUBS DEPLOYED</span>
      </div>
      <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black text-black tracking-tight font-display leading-[1.08]">
        Door-to-Door Poultry Catching Routes.
      </h1>
      <p className="max-w-2xl text-base sm:text-lg font-medium text-black/85 font-sans leading-relaxed">
        Pullum Ltd operates heated crew minibuses throughout Lincolnshire, Norfolk, Yorkshire, Shropshire, and Suffolk. We collect operatives right from their front doors and return them safely following each shift.
      </p>
    </div>
  </section>

  {/*  3. REGIONAL SELECTOR & INTERACTIVE MAP  */}
  <main className="flex-grow py-16 bg-[#090D14] text-white">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-5 space-y-6">
          <div className="bg-neutral-900/90 border border-neutral-800 rounded-md p-8 space-y-6 shadow-xl">
            ...
            {/*  Statutory Notice  */}
            <div className="p-4 rounded-md bg-amber-950/40 border border-amber-800/60 text-amber-200 text-xs font-sans space-y-1">
              <strong className="font-bold flex items-center gap-1.5 text-amber-300">
                <span>⚠️</span> UK Right to Work Mandatory
              </strong>
              <p className="text-[11px] text-amber-300/80">
                Pullum Ltd complies strictly with GLAA Labour Standards. We do not provide visa sponsorship. Candidates must have existing legal right to work in the UK.
              </p>
            </div>
        ...
        <div className="lg:col-span-7">
          <div className="bg-white rounded-md overflow-hidden shadow-2xl border border-neutral-800">
            <div className="bg-white px-5 py-3.5 border-b border-slate-200 flex items-center justify-between text-xs font-sans">
              <div className="flex items-center gap-2">
                ...
                <span className="text-slate-800 font-bold">Minibus Route Map</span>
              </div>
              <span className="text-slate-400 text-[11px] font-mono" id="map-coords-label">53.02° N, 0.25° W</span>
            </div>
            <div id="region-map" className="w-full h-[520px]"></div>
          </div>
        </div>
