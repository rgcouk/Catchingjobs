...
export default function SectorHub({ sectorId, onSelectRegion, onNavigate }: any) {
  ...
  const totalCrews = locations.reduce((sum, loc) => sum + (loc.activeCrews || 0), 0);
  ...
  {/*  1. SEAMLESS NAVIGATION (CADMIUM YELLOW matching index.jpg)  */}
  <PublicHeader />
  ...
  <section data-od-id="sector-hero" className="relative bg-[linear-gradient(178deg,#ff7c20,#ea5708,#ff4b00)] text-black py-16 lg:py-24 border-b border-black/10 overflow-hidden">
    ...
    <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6 z-10">
      ...
      <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-black/10 border border-black/15 text-black text-xs font-mono font-bold">
        <span>HARVEST DIVISIONS</span>
        <span className="opacity-50">·</span>
        <span>DEFRA &amp; AHVLA PROTOCOLS</span>
      </div>

      {/*  Headline  */}
      <div className="max-w-3xl space-y-4">
        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black text-black tracking-tight font-display leading-[1.08]">
          Commercial Poultry Harvesting Divisions.
        </h1>
        <p className="text-base sm:text-lg font-medium text-black/85 font-sans leading-relaxed">
          Pullum Ltd operates specialized broiler and turkey catching divisions across England. Fully equipped with modern heated Mercedes Sprinter transit, humane handling accreditation, and guaranteed weekly BACS payroll.
        </p>
      </div>

      {/*  Division Switcher Tabs  */}
      <div className="pt-4 flex items-center gap-3 font-display">
        <button id="tab-chicken" onClick={() => {}} className="px-6 py-3 rounded-md bg-black text-white font-bold text-sm shadow-md transition-all active:scale-95">
          Broiler Chicken Division
        </button>
        <button id="tab-turkey" onClick={() => {}} className="px-6 py-3 rounded-md bg-white text-black hover:bg-white/90 font-bold text-sm shadow-sm transition-all border border-black/10 active:scale-95">
  ...
  {/*  3. DIVISION CONTENT DETAIL  */}
  <main className="flex-grow py-16 bg-white">
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      
      {/*  CHICKEN DIVISION PANEL  */}
      <div id="panel-chicken" className="space-y-12">
        
        {/*  Summary Card  */}
        <div className="rounded-md border border-amber-200/60 bg-[#FFFDF0] p-8 lg:p-10 shadow-sm flex flex-col lg:flex-row gap-8 items-start justify-between">
          <div className="max-w-2xl space-y-4">
            <div className="inline-flex items-center gap-2 text-xs font-mono font-bold text-emerald-800 bg-emerald-100 px-3 py-1 rounded-full">
              <span className="w-2 h-2 rounded-full bg-emerald-600"></span>
              YEAR-ROUND CONTRACT OPERATIONS
            </div>
            <h2 className="text-3xl font-black text-black font-display tracking-tight">Broiler Chicken Catching Division</h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2">
              <div className="flex items-center gap-2 text-xs font-bold text-slate-800">
                <span className="text-black">✓</span> AHVLA &amp; Lantra Welfare (Level 2)
              </div>
              <div className="flex items-center gap-2 text-xs font-bold text-slate-800">
                <span className="text-black">✓</span> GLAA Licensed Provider #PULL0001
              </div>
              <div className="flex items-center gap-2 text-xs font-bold text-slate-800">
                <span className="text-black">✓</span> Free Door-to-Door Minibus Pickup
              </div>
              <div className="flex items-center gap-2 text-xs font-bold text-slate-800">
                <span className="text-black">✓</span> Guaranteed Friday BACS Pay
              </div>
            </div>
          </div>
          ...
          <div className="w-full lg:w-80 bg-black text-white rounded-md p-6 space-y-4 shrink-0 shadow-lg">
            ...
            <div className="text-3xl font-black font-display text-[#ff7c20]">£780 – £920<span className="text-xs text-white font-sans"> / wk</span></div>
            <div className="text-xs text-slate-300 space-y-1.5 font-sans border-t border-neutral-800 pt-3">
              ...
              <div className="flex justify-between"><span>Active Crews:</span><strong className="font-mono text-[#ff7c20]">{totalCrews || 34} Crews Live</strong></div>
            </div>
            <a href="#vacancies" className="block text-center w-full py-3 bg-[#ff7c20] hover:bg-[#e05500] text-black font-display font-bold text-xs uppercase rounded-md transition-all shadow-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="p-7 rounded-md border border-slate-200/80 bg-white space-y-3 shadow-sm">
            <div className="w-9 h-9 rounded-md bg-[#ff7c20] text-black font-black flex items-center justify-center font-display">1</div>
          ...
          <div className="p-7 rounded-md border border-slate-200/80 bg-white space-y-3 shadow-sm">
            <div className="w-9 h-9 rounded-md bg-[#ff7c20] text-black font-black flex items-center justify-center font-display">2</div>
          ...
          <div className="p-7 rounded-md border border-slate-200/80 bg-white space-y-3 shadow-sm">
            <div className="w-9 h-9 rounded-md bg-[#ff7c20] text-black font-black flex items-center justify-center font-display">3</div>
      ...
      <div id="panel-turkey" className="hidden space-y-12">
        
        {/*  Summary Card  */}
        <div className="rounded-md border border-neutral-800 bg-[#090D14] text-white p-8 lg:p-10 shadow-xl flex flex-col lg:flex-row gap-8 items-start justify-between">
          <div className="max-w-2xl space-y-4">
            <div className="inline-flex items-center gap-2 text-xs font-mono font-bold text-teal-400 bg-teal-950/80 border border-teal-800 px-3 py-1 rounded-full">
              <span className="w-2 h-2 rounded-full bg-teal-400 animate-pulse"></span>
              SEASONAL &amp; COMMERCIAL MODULE CONTRACTS
            </div>
            <h2 className="text-3xl font-black text-white font-display tracking-tight">Commercial Turkey Catching Division</h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2">
              <div className="flex items-center gap-2 text-xs font-bold text-slate-200">
                <span className="text-[#ff7c20]">✓</span> Defra &amp; AHVLA Turkey Welfare Compliance
              </div>
              <div className="flex items-center gap-2 text-xs font-bold text-slate-200">
                <span className="text-[#ff7c20]">✓</span> Two-Handed Heavy Bird Handling Protocols
              </div>
              <div className="flex items-center gap-2 text-xs font-bold text-slate-200">
                <span className="text-[#ff7c20]">✓</span> Free Minibus Pickup &amp; Return Service
              </div>
              <div className="flex items-center gap-2 text-xs font-bold text-slate-200">
                <span className="text-[#ff7c20]">✓</span> Premium Contract Earnings &amp; Shift Stability
              </div>
            </div>
          </div>
          ...
          <div className="w-full lg:w-80 bg-neutral-900 border border-neutral-800 text-white rounded-md p-6 space-y-4 shrink-0 shadow-lg">
            ...
            <div className="text-3xl font-black font-display text-[#ff7c20]">£850 – £1,050<span className="text-xs text-white font-sans"> / wk</span></div>
            <div className="text-xs text-slate-300 space-y-1.5 font-sans border-t border-neutral-800 pt-3">
              ...
              <div className="flex justify-between"><span>Active Hubs:</span><strong className="font-mono text-[#ff7c20]">Norfolk &amp; Lincs</strong></div>
            </div>
            <a href="#vacancies" className="block text-center w-full py-3 bg-[#ff7c20] hover:bg-[#e05500] text-black font-display font-bold text-xs uppercase rounded-md transition-all shadow-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="p-7 rounded-md border border-neutral-200 bg-white space-y-3 shadow-sm">
            <div className="w-9 h-9 rounded-md bg-black text-[#ff7c20] font-black flex items-center justify-center font-display">1</div>
          ...
          <div className="p-7 rounded-md border border-neutral-200 bg-white space-y-3 shadow-sm">
            <div className="w-9 h-9 rounded-md bg-black text-[#ff7c20] font-black flex items-center justify-center font-display">2</div>
          ...
          <div className="p-7 rounded-md border border-neutral-200 bg-white space-y-3 shadow-sm">
            <div className="w-9 h-9 rounded-md bg-black text-[#ff7c20] font-black flex items-center justify-center font-display">3</div>
