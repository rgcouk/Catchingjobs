...
export default function CorporateLander({ onNavigate }: any) {
  ...
  {/*  2. HERO SECTION  */}
  <section data-od-id="corporate-hero" className="relative bg-[linear-gradient(178deg,#ff7c20,#ea5708,#ff4b00)] text-black py-16 lg:py-20 border-b border-black/10 overflow-hidden">
    {/* Faded Background Image */}
    <div 
      className="absolute inset-0 z-0 bg-cover bg-center opacity-15 mix-blend-multiply"
      style={{ backgroundImage: `url('/images/corporate-logistics.jpg')` }}
    />
