...
export default function CorporateLander({ onNavigate }: any) {
  ...
  {/*  1. SEAMLESS TOP NAVIGATION (CADMIUM YELLOW matching index.jpg)  */}
  <header className="bg-[#FFC72C] border-b border-black/10 relative z-30">
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
      ...
      <div className="flex items-center space-x-5 font-display">
        <a href="brand-2026.html#portal" className="hidden sm:inline-block text-sm font-bold text-black hover:opacity-80">
          Log In
        </a>
        <a href="brand-2026.html#vacancies" className="px-5 py-2.5 rounded-full bg-black hover:bg-neutral-800 text-white font-bold text-xs uppercase tracking-wider transition-all shadow-sm active:scale-95">
          Quick Apply
        </a>
      </div>
  ...
  {/*  2. HERO SECTION  */}
  <section data-od-id="corporate-hero" className="relative bg-[#FFC72C] text-black py-16 lg:py-20 border-b border-black/10 overflow-hidden">
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6 relative z-10">
      <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-black/10 border border-black/15 text-black text-xs font-mono font-bold">
        <span>STATUTORY DISCLOSURE</span>
        <span className="opacity-50">·</span>
        <span>GLAA LICENCE PULL0001</span>
      </div>
      <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black text-black tracking-tight font-display leading-[1.08]">
        GLAA Compliance &amp; Ethical Labour Standards.
      </h1>
      <p className="max-w-2xl text-base sm:text-lg font-medium text-black/85 font-sans leading-relaxed">
        Pullum Ltd trades as CatchingJobs under full Gangmasters and Labour Abuse Authority (GLAA) licensing. We guarantee transparent employment, free door-to-door transit, zero worker charges, and exemplary poultry animal welfare standards across England.
      </p>
    </div>
  </section>

  {/*  3. STATUTORY CREDENTIALS GRID  */}
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="p-8 rounded-md border border-amber-200/60 bg-[#FFFDF0] space-y-4 shadow-sm hover:shadow-md transition-shadow">
          <div className="inline-block px-3 py-1 rounded-full bg-black text-[#FFC72C] font-mono text-xs font-bold">
            LICENCE PULL0001
          </div>
          <h2 className="text-2xl font-black font-display text-black">GLAA Licensed Provider</h2>
          <p className="text-xs text-slate-600 leading-relaxed font-sans">
            Fully licensed and audited labour provider under the Gangmasters (Licensing) Act 2004. We comply rigorously with all 8 GLAA Licensing Standards covering pay, health &amp; safety, transit, and worker welfare.
          </p>
          <div className="text-[11px] font-mono text-slate-500 font-bold border-t border-slate-200 pt-3">
            Status: Fully Active &amp; Verified
          </div>
        </div>

        <div className="p-8 rounded-md border border-amber-200/60 bg-[#FFFDF0] space-y-4 shadow-sm hover:shadow-md transition-shadow">
          <div className="inline-block px-3 py-1 rounded-full bg-emerald-800 text-emerald-100 font-mono text-xs font-bold">
            LEVEL 2 CERTIFIED
          </div>
          <h2 className="text-2xl font-black font-display text-black">Lantra Animal Welfare</h2>
          <p className="text-xs text-slate-600 leading-relaxed font-sans">
            All team leaders and catching operatives receive comprehensive training in Defra and AHVLA compliant handling, ensuring low stress, two-handed support, and complete bird welfare during loading.
          </p>
          <div className="text-[11px] font-mono text-slate-500 font-bold border-t border-slate-200 pt-3">
            Standards: Defra / AHVLA Poultry Codes
          </div>
        </div>

        <div className="p-8 rounded-md border border-amber-200/60 bg-[#FFFDF0] space-y-4 shadow-sm hover:shadow-md transition-shadow">
          <div className="inline-block px-3 py-1 rounded-full bg-blue-800 text-blue-100 font-mono text-xs font-bold">
            ZERO CHARGES
          </div>
          <h2 className="text-2xl font-black font-display text-black">Ethical Fair Recruitment</h2>
          <p className="text-xs text-slate-600 leading-relaxed font-sans">
            Operatives never pay fees for job placement, uniforms, or transit. Free heated Mercedes Sprinter minibuses collect workers from their door and return them safely after every night shift.
          </p>
          <div className="text-[11px] font-mono text-slate-500 font-bold border-t border-slate-200 pt-3">
            Policy: 100% Employer-Funded Operations
          </div>
        </div>

      </div>

      {/*  Core Commitments Detailed Table  */}
      <div className="rounded-md border border-slate-200/80 overflow-hidden shadow-sm">
        <div className="bg-[#090D14] text-white p-8 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
          ...
          <span className="px-3.5 py-1.5 rounded-full bg-[#FFC72C] text-black font-mono text-xs font-bold shrink-0">
            Updated September 2026
          </span>
        </div>

        <div className="divide-y divide-slate-100 text-sm font-sans bg-white">
          ...
          <div className="p-7 grid grid-cols-1 md:grid-cols-12 gap-4 items-start">
            ...
            <div className="md:col-span-9 text-slate-600 text-xs leading-relaxed">
              We own and manage our dedicated fleet of heated Mercedes Sprinter minibuses. Operatives are collected directly from home addresses across Boston, Sleaford, Lincoln, Grantham, Thetford, and Attleborough. Transit is completely free and driver allowances are provided.
            </div>
          </div>
          ...
          <div className="p-7 grid grid-cols-1 md:grid-cols-12 gap-4 items-start">
            ...
            <div className="md:col-span-9 text-slate-600 text-xs leading-relaxed">
              Wages are remitted directly via BACS every Friday morning with comprehensive digital payslips reflecting all hours, piece rates, shift allowances, and statutory holiday pay accruals.
            </div>
          </div>
          ...
          <div className="p-7 grid grid-cols-1 md:grid-cols-12 gap-4 items-start">
            ...
            <div className="md:col-span-9 text-slate-600 text-xs leading-relaxed">
              In accordance with UK Home Office immigration guidelines and GLAA requirements, Pullum Ltd performs mandatory Right to Work checks prior to shift allocation. Pullum Ltd does not offer visa sponsorships.
            </div>
          </div>
          ...
          <div className="p-7 grid grid-cols-1 md:grid-cols-12 gap-4 items-start">
            ...
            <div className="md:col-span-9 text-slate-600 text-xs leading-relaxed">
              Every crew member is issued complete welfare protective gear without charge, including disposable respirators, high-density work gloves, specialized biosecurity overalls, and protective footwear.
            </div>
          </div>
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
      <div className="flex flex-col md:flex-row md:items-start justify-between gap-8 pb-8 border-b border-neutral-800">
        <div className="space-y-4 max-w-xl">
                      {/*  Authentic White Native SVG Brand Monogram Lockup  */}
            <Link to="/" className="inline-flex items-center font-display font-black text-2xl text-white leading-none group no-underline" aria-label="CatchingJobs Home">
          ...
          <div className="pt-1 text-xs font-mono font-bold text-neutral-200">
            Compliance Hotline: <strong className="text-white">01205 330 190</strong>
          </div>
        </div>
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-4 font-mono text-[11px] text-neutral-500">
        <div>&copy; 2026 Pullum Ltd. All rights reserved. Operating across England.</div>
        <div>Weekly Payroll: Every Friday Direct to Bank · Zero Worker Deduction Fees</div>
      </div>
    </div>
  </footer>
