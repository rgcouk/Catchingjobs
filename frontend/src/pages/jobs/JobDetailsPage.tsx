 ...
 * Palette: Cadmium Yellow (#FFCC00), Deep Obsidian (#090D14), Crisp White, Ivory (#FFFDF0)
  ...
  if (loading && !job) {
    return (
      <div className="font-sans w-full min-h-[60vh] bg-white text-[#090D14] flex flex-col items-center justify-center p-8 space-y-4">
        <div className="w-10 h-10 border-3 border-black border-t-[#FFCC00] rounded-full animate-spin" />
    ...
    return (
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-8 text-center space-y-6">
        ...
        <div className="flex flex-wrap items-center justify-center gap-3">
          ...
          >
            Explore Chicken Vacancies <ArrowRight className="w-4 h-4 text-[#FFCC00]" />
          </Link>
        </div>
      </div>
      <PublicFooter />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
          <div className="max-w-3xl space-y-5">
            ...
            <div className="flex flex-wrap items-center gap-2">
              <span className="inline-flex items-center gap-1.5 text-xs font-mono font-bold uppercase px-3 py-1 rounded bg-[#FFCC00] text-black shadow-xs">
              ...
              <span className="inline-flex items-center gap-1.5 text-xs font-mono text-slate-300 bg-white/5 border border-white/10 px-3 py-1 rounded">
                <Truck className="w-3.5 h-3.5 text-[#FFCC00]" />
            ...
            <div className="space-y-2">
              ...
              <p className="text-xl sm:text-2xl text-[#FFCC00] font-mono font-bold">
                {job.payRate}{' '}
            ...
            <div className="flex flex-wrap items-center gap-4 text-xs sm:text-sm font-mono text-slate-200 pt-2">
              ...
              <div className="flex items-center gap-1.5 bg-black/60 px-3 py-1.5 rounded-md border border-white/15 text-[#FFCC00] font-bold">
            ...
            <div className="flex flex-wrap items-center gap-3 pt-3">
              <a
                ...
                className="inline-flex items-center gap-2 bg-[#FFCC00] hover:bg-[#E5B800] text-black font-display font-black text-xs uppercase tracking-wider px-6 py-3.5 rounded-md transition-all shadow-xs no-underline"
              >
              ...
              >
                {copiedLink ? (
                  <>
                    ...
                    <span className="text-[#FFCC00]">Copied!</span>
                  </>
                ) : (
                  <>
                  ...
                  {relatedJobs.map((relJob) => (
                    ...
                    >
                      <div className="space-y-1.5">
                        <span className="text-[10px] font-mono uppercase font-bold text-black bg-[#FFCC00] px-2 py-0.5 rounded">
