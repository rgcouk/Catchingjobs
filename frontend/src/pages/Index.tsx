...
export default function Index({ onNavigate }: any) {
  ...
  <section id="home" data-od-id="hero-section" className="relative bg-[#FFCC00] pt-12 pb-20 lg:pt-16 lg:pb-28 overflow-hidden border-b border-black/10">
        ...
        <div className="rounded-md border border-neutral-800 bg-[#090D14] text-white p-8 sm:p-10 flex flex-col justify-between shadow-xl hover:shadow-2xl transition-shadow">
          <div className="space-y-6">
            ...
            <div className="flex flex-wrap items-center gap-2">
              ...
              <span className="px-3 py-1 rounded-full bg-[#FFCC00] text-black text-xs font-mono font-bold uppercase tracking-wider">
                SEASONAL PEAK PAY
              </span>
            </div>
            ...
            <ul className="space-y-2.5 text-xs sm:text-sm font-semibold text-slate-200 font-sans">
              <li className="flex items-center gap-2.5">
                <span className="text-[#FFCC00] font-black text-base">✓</span>
                <span>Free Door-to-Door Home Pickup</span>
              </li>
              <li className="flex items-center gap-2.5">
                <span className="text-[#FFCC00] font-black text-base">✓</span>
          ...
          {/*  Bottom Button  */}
          <div className="pt-8">
            <Link to="/turkeys" className="inline-flex items-center justify-center px-6 py-3.5 rounded-md bg-[#FFCC00] hover:bg-[#E5B800] text-black font-display font-bold text-xs uppercase tracking-wider transition-all shadow active:scale-95">
        ...
        <div className="lg:col-span-8 rounded-md overflow-hidden border border-neutral-800 bg-white shadow-2xl">
          ...
          <div className="bg-[#FFFDF0] px-5 py-4 border-t border-slate-200 flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-3">
              <button onClick={() => {}} className="px-4 py-2 rounded-sm bg-[#FFCC00] hover:bg-[#E5B800] text-black font-display font-bold text-xs uppercase tracking-wider transition-all shadow-sm active:scale-95">
                Apply Chicken Squad →
              </button>
  ...
  <section id="directory" data-od-id="regional-directory" className="py-16 sm:py-24 bg-[#F8FAFC] border-b border-slate-200">
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10">
      ...
      <div className="max-w-3xl space-y-2">
        <span className="text-xs font-mono font-bold text-black uppercase tracking-widest bg-[#FFCC00]/30 px-2.5 py-1 rounded">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="rounded-md border border-black bg-black text-white p-7 space-y-4 flex flex-col justify-between shadow-md">
          <div className="space-y-2">
            <span className="text-xs font-mono text-[#FFCC00] font-bold uppercase">FAST-TRACK ONBOARDING</span>
          ...
          <button onClick={() => {}} className="w-full py-3 bg-[#FFCC00] hover:bg-[#E5B800] text-black font-display font-bold text-xs uppercase rounded-md transition-all shadow active:scale-95">
            Apply in 60 Seconds →
          </button>
        </div>
      ...
      <div className="flex flex-col md:flex-row md:items-start justify-between gap-8 pb-8 border-b border-neutral-800">
        ...
        <div className="space-y-4 max-w-xl">
          ...
          <div className="flex flex-wrap items-center gap-x-6 gap-y-2 text-xs font-semibold text-neutral-300 pt-2 font-display">
            ...
            <Link to="/chickens" className="hover:text-[#FFCC00] transition-colors">Broiler Chicken Catching</Link>
            <Link to="/turkeys" className="hover:text-[#FFCC00] transition-colors">Commercial Turkey Catching</Link>
            <Link to="/chickens" className="hover:text-[#FFCC00] transition-colors">Boston Depot</Link>
            <Link to="/register" className="hover:text-[#FFCC00] transition-colors">Vacancies</Link>
            <Link to="/login" className="hover:text-[#FFCC00] transition-colors">Candidate Portal</Link>
          </div>
        ...
        <div className="space-y-4 text-left md:text-right">
          <div className="flex flex-wrap md:justify-end items-center gap-2 font-mono text-xs">
            <span className="px-3 py-1 rounded-md bg-neutral-900 border border-neutral-700 text-[#FFCC00] font-bold">
  ...
  <div id="apply-modal" className="fixed inset-0 z-50 bg-black/80 backdrop-blur-sm hidden items-center justify-center p-4">
    <div className="bg-white rounded-md max-w-lg w-full p-8 relative shadow-2xl space-y-6">
      ...
      <div>
        <span className="px-3 py-1 rounded-full bg-[#FFCC00] text-black font-mono text-[11px] font-bold uppercase">
      ...
      <form onSubmit={(e) => e.preventDefault()} className="space-y-4 text-xs font-sans">
        ...
        <button type="submit" className="w-full py-3.5 rounded-md bg-[#FFCC00] hover:bg-[#E5B800] text-black font-display font-bold text-sm uppercase tracking-wider transition-all shadow-md mt-2 active:scale-95">
