    ...
    >
      ...
      <div className="space-y-1.5 pb-4 border-b border-slate-100">
        <div className="flex items-center justify-between">
          <span className="text-[10px] font-mono font-bold uppercase tracking-wider text-black bg-[#FFCC00] px-2.5 py-0.5 rounded">
        ...
        {isSignedIn && user && (
          <div className="pt-2">
            <div className="p-2.5 bg-[#FFFDF0] border border-amber-200/80 rounded-md flex items-center justify-between text-xs font-mono">
              ...
              <span className="text-[9px] font-mono font-bold bg-black text-[#FFCC00] px-1.5 py-0.5 rounded uppercase">
                Active
              </span>
            </div>
          </div>
              ...
              >
                <button
                  ...
                  className={`px-3 py-1 text-xs font-mono uppercase rounded-md transition-colors cursor-pointer ${
                    watchRtw === true
                      ? 'bg-black text-[#FFCC00] font-bold shadow-xs'
