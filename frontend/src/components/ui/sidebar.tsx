    ...
    return (
      <main
        ...
        className={cn(
          ...
          'md:peer-data-[variant=inset]:m-2 md:peer-data-[state=collapsed]:peer-data-[variant=inset]:ml-2 md:peer-data-[variant=inset]:ml-0 md:peer-data-[variant=inset]:rounded-sm md:peer-data-[variant=inset]:shadow md:peer-data-[variant=inset]:border',
          className,
        )}
        {...props}
      />
...
>(({ className, showIcon = false, ...props }, ref) => {
  // Static width for SSR deterministic hydration
  const width = '75%';
