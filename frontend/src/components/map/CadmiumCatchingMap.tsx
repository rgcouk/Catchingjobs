    ...
    try {
      ...
      currentRegion.points.forEach((pt) => {
        const yellowIcon = L.divIcon({
          ...
          html: `<div style="background-color:#FFCC00; border:2px solid #090D14; border-radius:6px; padding:3px 6px; font-weight:800; font-size:10px; font-family:'JetBrains Mono',monospace; color:#090D14; box-shadow:0 2px 6px rgba(0,0,0,0.2); white-space:nowrap; display:flex; align-items:center; gap:3px;">
          ...
          return (
            <button
              ...
              className={`w-full text-left p-4 rounded transition-all flex items-center justify-between cursor-pointer ${
                isSelected
                  ? 'bg-[#FFCC00] text-black font-display font-bold border-l-4 border-black shadow-xs'
      ...
      <div className="lg:col-span-8 bg-white rounded-md border border-slate-200 overflow-hidden shadow-card text-black flex flex-col justify-between">
        ...
        <div className="p-4 bg-white border-t border-slate-200 flex flex-wrap items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            <Link
              to="/chickens"
              className="bg-[#FFCC00] hover:bg-[#E6B800] text-black font-display font-bold text-xs px-4 py-2.5 rounded transition-colors shadow-xs no-underline inline-flex items-center gap-1"
            >
