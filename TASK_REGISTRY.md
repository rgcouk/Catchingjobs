...
| T-003 | CRM Backend: Support applicant status updates & tracking | pending | BackendDevAgent | API endpoint `/api/admin/applications/:id` accepts PATCH for status changes |
