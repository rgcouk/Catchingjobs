    ...
    <div className="flex w-full min-h-[calc(100vh-64px)] bg-[#F8FAFC]">
      ...
      <aside className="hidden md:flex flex-col w-64 border-r border-slate-200 bg-white px-4 py-10 shrink-0">
        ...
        <nav className="flex-1 space-y-1.5">
          <Button
            variant="ghost"
            className="w-full justify-start text-[#059669] bg-[#ECFDF5] hover:bg-[#D1FAE5] hover:text-[#059669] font-medium text-sm rounded-lg"
          >
          ...
          <Button
            variant="ghost"
            className="w-full justify-start text-[#64748B] hover:text-[#0F172A] hover:bg-slate-100 font-medium text-sm rounded-lg"
          >
