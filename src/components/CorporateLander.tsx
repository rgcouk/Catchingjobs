    ...
    <div className="space-y-10 font-sans">
      ...
      <section className="bg-white border border-slate-200 rounded-2xl p-8 sm:p-12 space-y-8 shadow-sm relative overflow-hidden">
        ...
        <div className="max-w-3xl space-y-4 relative z-10">
          ...
          <h1 className="text-3xl sm:text-5xl font-black tracking-tight text-slate-900 leading-none space-y-1">
            <span className="block text-slate-900">Ready to Start Your Career in Poultry Catching?</span>
            <span className="block text-slate-500 font-medium text-2xl sm:text-3xl mt-2">Looking for a Fresh Direction in the Industry?</span>
          </h1>
          <p className="text-sm sm:text-base text-slate-600 leading-relaxed max-w-2xl">
            Pullum Ltd provides a professional approach to agricultural trade work, built on security, respect, and growth. We are recruiting across the UK.
          </p>
        </div>
        ...
        <div className="border-t border-slate-150 pt-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 relative z-10">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h4 className="font-bold text-slate-900 text-xs sm:text-sm">New and eager to begin</h4>
              <p className="text-[11px] text-slate-500 leading-snug mt-0.5">Full support, welfare training, and fast licensing.</p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              <h4 className="font-bold text-slate-900 text-xs sm:text-sm">Experienced & ready for challenge</h4>
              <p className="text-[11px] text-slate-500 leading-snug mt-0.5">Industry-leading rates and premium schedules.</p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              <h4 className="font-bold text-slate-900 text-xs sm:text-sm">Whole teams seeking support</h4>
              <p className="text-[11px] text-slate-500 leading-snug mt-0.5">We accommodate intact local crews with clean transport.</p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              <h4 className="font-bold text-slate-900 text-xs sm:text-sm">Company that's growing fast</h4>
              <p className="text-[11px] text-slate-500 leading-snug mt-0.5">Career progression into team lead or supervisory roles.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="space-y-6">
        <div className="text-center max-w-2xl mx-auto space-y-2">
          <h2 className="text-2xl sm:text-3xl font-black text-slate-900 tracking-tight">We Offer</h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-white border border-slate-200 p-6 rounded-xl space-y-3 shadow-sm flex flex-col justify-between">
            <div className="space-y-3.5">
              ...
              <h3 className="font-bold text-slate-900 text-sm sm:text-base">Supportive, Reliable Teams</h3>
              <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
      ...
      <section className="space-y-4 pt-4 border-t border-slate-200">
        <div>
          ...
          <p className="text-xs text-slate-500">Access regional recruitment divisions, Safety Culture training, and our live location hubs.</p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-5">
          ...
          >
            <div className="space-y-3">
              ...
              <p className="text-xs text-slate-500 leading-relaxed">
                Check regional operational networks, county active numbers, event logs, compliance guides, and current agricultural vacancy alerts.
              </p>
            </div>
          ...
          >
            <div className="space-y-3">
              ...
              <p className="text-xs text-slate-500 leading-relaxed">
                Access specialized crew rosters, night shift rates, breeders transfer, and Safety Culture integration parameters.
              </p>
            </div>
            <div className="pt-3 border-t border-slate-100 mt-4 flex items-center justify-between text-xs font-bold text-slate-500 group-hover:text-slate-950 transition-colors">
          ...
          >
            <div className="space-y-3">
              ...
              <p className="text-xs text-slate-500 leading-relaxed">
                Access heavy agricultural operational parameters, weight handling compliance lists, and safety checklists.
              </p>
            </div>
            <div className="pt-3 border-t border-slate-100 mt-4 flex items-center justify-between text-xs font-bold text-slate-500 group-hover:text-slate-950 transition-colors">
